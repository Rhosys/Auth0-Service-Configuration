      ...
      const profile = {
        ...
        integrationData: {
          ...
          encrypted: encrypt({
            ...
            botAccessToken: ctx.bot.bot_access_token
          }),
          appUserId: ctx.bot.bot_user_id,
          appId: 'ADZMCGNJ0',
          slackUserId: ctx.user_id,
          slackTeamId: ctx.team_id,
          teamName: ctx.team_name,
        },
        metadata: {
          platformUserId: undefined,
          loginId: `slack|${ctx.user_id}`,
          slackUser: ctx.user_id,
          slackTeam: ctx.team_id,
          teamName: ctx.team_name,
          savedScopes: ctx.scope
          profile: {
            ...slackResponse.user,
            profile: undefined,
            ...slackResponse.user.profile
          }
        }
      };
      cb(null, profile);
